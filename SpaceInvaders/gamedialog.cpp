...
GameDialog::~GameDialog() {
    ...
    //make coordinate tracking of the mouse pointer possible
...
//player can shoot laser from the spaceship with left click
...
//    menu->openScore();
    qDebug() << "GameDialog::showScore is executed";
}

void GameDialog::setVeryEasyMode()
{
    //set the game to very easy difficulty
    qDebug() << "Game is set to Very Easy Difficulty!";

    this->frames = 130;
    this->setFocus();
}

void GameDialog::setEasyMode()
{

    //set the game to easy difficulty
    qDebug() << "Game is set to Easy Difficulty!";

    this->frames = 100;
    this->setFocus();
}

void GameDialog::setNormalMode()
{
    //set the game to normal difficulty
    qDebug() << "Game is set to Normal Difficulty!";

    this->frames = 70;
    this->setFocus();
}

void GameDialog::setHardMode()
{
    //set the game to hard difficulty
    qDebug() << "Game is set to Hard Difficulty!";
...
void GameDialog::nextFrame() {
    ...
    //only update the swarm and laser bullets at each frame
    //if keyboard or mouse input is detected
